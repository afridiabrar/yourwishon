                        ...
                        <div class="shop-sidebar mb-30">
                            ...
                            <ul>
                                @if(count($category) > 0)
                                     ...
                                     <li><a href="category/{{$v->slug}}">{{ $v->name}} </a></li>                                         
                                     @endforeach   
                                @endif
                            </ul>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-wrap">
                                                        ...
                                                        <a href="product-details.html"><img src="{{ asset($item->featured_image)}}" alt="Produce Images"></a>
                                                            
                                                            <div class="product-action">
                                                                <a href="#" class="add-to-cart"><i class="ion-ios-cart-outline"></i></a>
                                                                <a href="#" class="quick-view" data-toggle="modal" data-target="#exampleModalCenter"><i class="ionicons ion-ios-eye-outline"></i></a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-4 col-md-5">
                                                ...
                                                <div class="single-product-wrap">
                                                    ...
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('public/assets/images/product/product-06.jpg')}}" alt="Produce Images"></a>
                                                        <div class="product-action">
                                                            <a href="#" class="add-to-cart"><i class="ion-ios-cart-outline"></i>
                                                            </a>
